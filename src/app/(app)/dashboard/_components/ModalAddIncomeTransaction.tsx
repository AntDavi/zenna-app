...
export default function ModalAddIncomeTransaction() {
  ...
  const handleAmountChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    console.log("🔢 [ModalAddIncome] Input original:", e.target.value);
    const formatted = formatCurrency(e.target.value);
    console.log("🔢 [ModalAddIncome] Valor formatado:", formatted);
    form.setValue("amount", formatted);
  };

  const onSubmit = async (values: FormValues) => {
    console.log("📝 [ModalAddIncome] Valores do formulário:", values);
    setIsLoading(true);
    ...
    try {
      ...
      console.log("📋 [ModalAddIncome] FormData sendo enviada:");
